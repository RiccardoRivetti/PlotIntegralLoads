...
% WING
getPlots(plotControls,index,time,alpha,CD.wing,CL.wing,eff.wing,'wing',wd,saveFile)

% PLANE
getPlots(plotControls,index,time,alpha,CD.plane,CL.plane,eff.plane,'plane',wd,saveFile)
